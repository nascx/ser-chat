  ...
  return (
    <div className="w-screen flex">
      <div className="w-[25%] h-screen bg-secondary overflow-scroll">
        <div className="flex items-center my-8 mx-14">
          ...
          <div className="ml-8">
            ...
            <p className="text-lg font-light cursor-pointer">Minha conta</p>
          </div>
        </div>
        <hr />
        <div className="mx-14 mt-10">
          <div className="text-primary text-lg cursor-pointer">Conversas</div>
          <div>
            {conversations.length > 0 ? (
              conversations.map(({ conversationId, user }) => {
                return (
                  <div className="flex items-center py-8 border-b border-b-gray-300 rounded-xl">
                    <div
              ...
              <div className="text-center text-lg font-semibold mt-24 rounded-xl">
                Sem conversas
              </div>
            )}
          </div>
      ...
      <div className="w-[25%] h-screen bg-light px-8 py-16 overflow-scroll">
        <div className="text-primary text-lg cursor-pointer">Pessoas</div>
        <div>
          {users.length > 0 ? (
